...
rec {
  ...
  workspaceMembers = {
    ...
    "erased-serde-explanation" = rec {
      packageId = "erased-serde-explanation";
      build = internal.buildRustCrateWithFeatures {
        packageId = "erased-serde-explanation";
      };
    ...
    "erased-serde-test" = rec {
      packageId = "erased-serde-test";
      build = internal.buildRustCrateWithFeatures {
        packageId = "erased-serde-test";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "erased-serde" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "std" "unstable-debug" ];
      };
      "erased-serde-explanation" = rec {
        crateName = "erased-serde-explanation";
        version = "0.0.1";
        edition = "2021";
        crateBin = [
          {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./explanation; };
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "erased-serde-test" = rec {
        crateName = "erased-serde-test";
        version = "0.0.1";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tests/crate; };
        libName = "erased_serde_test";
        libPath = "lib.rs";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
